...
library OracleLibrary {
    ...
    function consult(
        ...
        (int56[] memory tickCumulatives, uint160[] memory secondsPerLiquidityCumulativeX128s) = IPancakeV3Pool(pool)
            .observe(secondsAgos);
    ...
    function getOldestObservationSecondsAgo(address pool) internal view returns (uint32 secondsAgo) {
        ...
        (uint32 observationTimestamp, , , bool initialized) = IPancakeV3Pool(pool).observations(
