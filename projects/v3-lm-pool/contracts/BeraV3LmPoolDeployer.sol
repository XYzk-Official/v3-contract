...
contract BeraV3LmPoolDeployer {
    ...
    function deploy(IBeraV3Pool pool) external onlyMasterChef returns (IBeraV3LmPool lmPool) {
        lmPool = new BeraV3LmPool(address(pool), masterChef, uint32(block.timestamp));
