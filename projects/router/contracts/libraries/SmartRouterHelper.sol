...
library SmartRouterHelper {
    ...
    /// @param deployer The xyzk V3 deployer contract address
    ...
    function getPool(address deployer, address tokenA, address tokenB, uint24 fee) public pure returns (IXYzKV3Pool) {
        return IXYzKV3Pool(computeAddress(deployer, getPoolKey(tokenA, tokenB, fee)));
    }

    /// @notice Returns the address of a valid xyzk V3 Pool
    /// @param deployer The contract address of the xyzk V3 deployer
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) public view returns (IXYzKV3Pool pool) {
    ...
    /// @return pool The V3 pool contract address
    function verifyCallback(address deployer, PoolKey memory poolKey) public view returns (IXYzKV3Pool pool) {
        pool = IXYzKV3Pool(computeAddress(deployer, poolKey));
