...
import './XYZKStableSwapLP.sol';

contract XYZKStableSwapLPFactory is Ownable {
    ...
    function createSwapLP(
        ...
        // create LP token
        bytes memory bytecode = type(XYZKStableSwapLP).creationCode;
        ...
        XYZKStableSwapLP(lpToken).setMinter(_minter);
