...
import './interfaces/IXYZKStableSwap.sol';
import './interfaces/IXYZKStableSwapLP.sol';
import './interfaces/IXYZKStableSwapDeployer.sol';
import './interfaces/IXYZKStableSwapLPFactory.sol';

contract XYZKStableSwapFactory is Ownable {
    ...
    IXYZKStableSwapLPFactory public immutable LPFactory;
    IXYZKStableSwapDeployer public immutable SwapTwoPoolDeployer;
    IXYZKStableSwapDeployer public immutable SwapThreePoolDeployer;
     ...
     */
    constructor(
        IXYZKStableSwapLPFactory _LPFactory,
        IXYZKStableSwapDeployer _SwapTwoPoolDeployer,
        IXYZKStableSwapDeployer _SwapThreePoolDeployer
    ) {
    ...
    function createSwapPair(
        ...
        IXYZKStableSwapLP(LP).setMinter(swapContract);
    ...
    function addPairInfo(address _swapContract) external onlyOwner {
        IXYZKStableSwap swap = IXYZKStableSwap(_swapContract);
